  ...
  return (
    <main className="main">
      <section className="results-section">
        <div className="wrapper">
          <div className="results-section__text">
            <p className="results-section__text__top flex-center">
              ТОЧНЫЕ РЕЗУЛЬТАТЫ
            </p>
            <p className="results-section__text__bottom flex-center">
              ТОЧНО В СРОК
            </p>
          </div>
          ...
          <div className="results-section__kapibara">
            <img
              className="results-section__kapibara__img"
              src="./images/kapibara.png"
              alt="Kapibara"
            />
          </div>
        </div>
      ...
      <section className="laboratory-section" id="laboratory">
        <h1 className="laboratory-section__description wrapper">
        ...
        <div className="laboratory-box">
          <div className="wrapper">
            <div className="laboratory-box__content">
              ...
              <p className="laboratory-box__content__text">
              ...
              <a
                className="laboratory-box__content__btn flex-center"
                href="#feedback"
              >
            ...
            <img
              className="laboratory-box__img"
              src="./images/kapibara-lab.jpg"
            />
